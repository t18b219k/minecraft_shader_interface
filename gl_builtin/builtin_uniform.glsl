...
layout(set=0,binding=0)uniform _gl_EmbeddedUniforms{
    mat4 _gl_ModelViewMatrix;
    mat4 _gl_ProjectionMatrix;
    mat4 _gl_ModelViewProjectionMatrix;
    mat4 _gl_TextureMatrix[_gl_MaxTextureCoords];
    ...
    _gl_LightProducts _gl_FrontLightProduct[_gl_MaxLights];
    _gl_LightProducts _gl_BackLightProduct[_gl_MaxLights];
    vec4  _gl_TextureEnvColor[_gl_MaxTextureUnits];
    vec4  _gl_EyePlaneS[_gl_MaxTextureCoords];
    vec4  _gl_EyePlaneT[_gl_MaxTextureCoords];
    vec4  _gl_EyePlaneR[_gl_MaxTextureCoords];
    vec4  _gl_EyePlaneQ[_gl_MaxTextureCoords];
    vec4  _gl_ObjectPlaneS[_gl_MaxTextureCoords];
    vec4  _gl_ObjectPlaneT[_gl_MaxTextureCoords];
    vec4  _gl_ObjectPlaneR[_gl_MaxTextureCoords];
    vec4  _gl_ObjectPlaneQ[_gl_MaxTextureCoords];
