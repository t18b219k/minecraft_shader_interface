...
impl Rename {
    pub fn init() -> Self {
        ...
        composite_and_deferred_shader_table
            .insert("composite".to_string(), "colortex3".to_string());
        composite_and_deferred_shader_table.insert("shadow".to_string(), "shadowtex0".to_string());
        composite_and_deferred_shader_table
            .insert("watershadow".to_string(), "shadowtex0".to_string());
        composite_and_deferred_shader_table
            .insert("gdepthtex".to_string(), "depthtex0".to_string());
        ...
        composite_and_deferred_shader_table
            .insert("shadowcolor".to_string(), "shadowcolor0".to_string());
        Self {
